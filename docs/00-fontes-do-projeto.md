...
| Instruções para IA | [`AGENTS.md`](../AGENTS.md) | [`docs/14-instrucoes-para-ia.md`](14-instrucoes-para-ia.md), [`docs/ai/harness-v1.md`](ai/harness-v1.md), [`docs/ai/task-classification.md`](ai/task-classification.md), [`docs/ai/context-routing.md`](ai/context-routing.md), [`docs/ai/process-workflows.md`](ai/process-workflows.md), [`docs/ai/orchestration.md`](ai/orchestration.md), [`docs/ai/static-analysis.md`](ai/static-analysis.md), [`docs/ai/code-budgets.md`](ai/code-budgets.md), [`docs/ai/architecture-boundaries.md`](ai/architecture-boundaries.md), [`docs/ai/quality-gates.md`](ai/quality-gates.md), [`docs/ai/meta-goal-runtime.md`](ai/meta-goal-runtime.md), [`docs/ai/memory-policy.md`](ai/memory-policy.md), este catálogo | Fonte operacional | Vigente; Harness V1 + routing, quality, Meta Goal e memory on-demand |
