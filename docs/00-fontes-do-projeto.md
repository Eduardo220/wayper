...
| Instruções para IA | [`AGENTS.md`](../AGENTS.md) | [`docs/14-instrucoes-para-ia.md`](14-instrucoes-para-ia.md), [`docs/ai/harness-v1.md`](ai/harness-v1.md), [`docs/ai/task-classification.md`](ai/task-classification.md), [`docs/ai/context-routing.md`](ai/context-routing.md), [`docs/ai/process-workflows.md`](ai/process-workflows.md), [`docs/ai/orchestration.md`](ai/orchestration.md), [`docs/ai/static-analysis.md`](ai/static-analysis.md), [`docs/ai/code-budgets.md`](ai/code-budgets.md), [`docs/ai/architecture-boundaries.md`](ai/architecture-boundaries.md), este catálogo | Fonte operacional | Vigente; Harness V1 + routing, skills, orchestration e quality gates |
...
| Documentação, Harness ou instruções de agents | [`docs/14-instrucoes-para-ia.md`](14-instrucoes-para-ia.md), [`docs/ai/harness-v1.md`](ai/harness-v1.md), [`docs/ai/task-classification.md`](ai/task-classification.md), [`docs/ai/context-routing.md`](ai/context-routing.md), [`docs/ai/process-workflows.md`](ai/process-workflows.md), [`docs/ai/orchestration.md`](ai/orchestration.md), [`docs/product/README.md`](product/README.md), [`docs/wayper/00-index.md`](wayper/00-index.md), [`docs/08-decisoes-tecnicas.md`](08-decisoes-tecnicas.md), [`docs/18-changelog-produto.md`](18-changelog-produto.md) e [`docs/19-revisoes-de-implementacao.md`](19-revisoes-de-implementacao.md) |
