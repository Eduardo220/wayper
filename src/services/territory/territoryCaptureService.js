    ...
    const capturedTerritory = enrichTerritoryGeometry(
      {
        ...
        synced: false,
        distanceMeters: toFiniteNumber(distanceMeters, 0),
        distanceM: toFiniteNumber(distanceMeters, 0),
        durationSeconds: toFiniteNumber(durationSeconds, 0),
        durationSec: toFiniteNumber(durationSeconds, 0),
        color: color || "#00E676",
        strokeColor: strokeColor || color || "#00E676",
        fillOpacity,
        routeGeometry: capture.routeGeometry || null,
        rawRouteRef: null,
        stats: {
          pointsUsed: capture.meta?.quality?.pointsUsed ?? capture.meta?.pointCount ?? 0,
          pointsDiscarded: capture.meta?.quality?.pointsDiscarded ?? 0,
          averageAccuracy: capture.meta?.quality?.averageAccuracy ?? null,
          closureDetected: Boolean(capture.meta?.closureDetected),
          loopCount: capture.meta?.loopCount || 0,
          candidateCount: capture.meta?.candidateCount || 0,
        },
      },
      {
